...
## 
## Actually the function is a list containing a function to:
...
cacheSolve <- function(x, ...) {
        ...
        mat <- x$getinverse     ## makeCacheMatrix is a function that stores a list of functions; to use these functions stored in it, one needs to subset the main function assigned to x
                                ## beforehand.
        if(!is.null(mat)) {
